 ...
 */
class Cell(val x: CellUnit, val y: CellUnit, val windDirection: Int, val windSpeed: Float, val effects : Array[CellEffect]) {
    def this(x: CellUnit, y: CellUnit, windDirection : Int, windSpeed: Float) = {
